...
- **Examples:** 
  - *"Mercury." By Sarah Chen, AI-assisted by Claude (word choice and line break suggestions)*
  - *Venus.* Dir. by Chris Taylor, AI-assisted by Runway ML (visual effects and scene generation)
...
**Basic:** `By Sarah Chen, AI-assisted by Claude`

**Detailed:** `By Sarah Chen, AI-assisted by Claude (structural feedback and grammar refinement)`
...
- **v2.0** (November 2024) - Simplified to two-tier system based on community feedback
- **v1.0** (November 2024) - Initial three-tier release
...
> Malone, D. S. (2024). *AACC: Attribution for AI-Enhanced Creative Content* (Version 2.0). https://github.com/dzmalone/aacc
